% !TeX program = xelatex
\documentclass[10pt,twoside=true]{scrartcl}
...
\input{document/sperrvermerk}% kann auskommentiert werden.
%***********************************************************

\input{document/gender_erklaerung}% kann auskommentiert werden.

% TODO: Anpassung des Inhalts, Danksagung kann auch auskommentiert werden
\input{inhalt/danksagung}% kann auskommentiert werden.
\input{inhalt/kurzfassung}
\input{inhalt/abkuerzungen}% kann auskommentiert werden.
%***********************************************************
...
% TODO: Anpassung des Inhalts oder auskommentieren
\input{inhalt/normenverzeichnis}% kann auskommentiert werden.
%***********************************************************
