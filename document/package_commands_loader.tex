...
\usepackage[version=4]{mhchem}% Für die chemische Formel
...
\usetikzlibrary{%
	...
	intersections,
	through,
	decorations.pathmorphing,				% Liniendekoration
	arrows.meta,							% Pfeile
}
\pgfplotsset{compat=1.15}

\mhchemoptions{arrows=pgf-filled}% Schönere Pfeile für chemische Formeln
